...
\begin{description}[A]
\item[A]  Introduction:  Observations of the ISM
\item[B]  Microscopic Processes. % (ref. Dyson \& Williams + Spitzer + Shu).
\item[C]  Astrophysics of Gaseous Nebulae. % (ref. Osterbrock + review de Williams).
\end{description}

\column{0.5\textwidth}

\begin{description}[A]
\item[D] Interstellar Dust.
\item[E] Dynamics of the ISM. 
\item[F] Selectec topics: protoplanetary disks, planetary nebulae, SNRs.
...
%}
%
\logo{\includegraphics[width=2cm]{helix_hst.jpg}}
