...
%\documentclass[compress,english,10pt]{extarticle}
%\usepackage{beamerarticle}
...
%}%
%
%\logo{\includegraphics[width=2cm]{./A/welsh_fig16.png}}
%\input{./A/A}
...
\logo{\includegraphics[width=2cm]{./B/ArVI_pop.pdf}}
\input{./B/B}

%\input{./C/C}

%\logo{\includegraphics[width=2cm]{./D/draine_araa_f7.pdf}}
%\input{./D/D}

%\logo{\includegraphics[width=2cm]{./E/logo_E.jpg}}
%\input{./E/E}
